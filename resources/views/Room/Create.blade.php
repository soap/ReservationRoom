            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="from-group">
                        ...
                        <input type="datetime-local" name="start_time" class="form-control" placeholder="start_time">
                        @error('startTime')
                        <div class="alert alert-danger">{{$message}}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-12">
                    <div class="from-group">
                        ...
                        <input type="datetime-local" name="stop_time" class="form-control" placeholder="stop_time">
                        @error('stopTime')
                        <div class="alert alert-danger">{{$message}}</div>
                        @enderror
                    </div>
